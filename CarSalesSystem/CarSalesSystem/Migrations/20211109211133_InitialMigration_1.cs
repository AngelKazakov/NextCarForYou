        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EuroStandardId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "AdvertisementsExtras",
                columns: table => new
                {
                    AdvertisementId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ExtrasId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementsExtras", x => new { x.AdvertisementId, x.ExtrasId });
                    table.ForeignKey(
                        name: "FK_AdvertisementsExtras_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementsExtras_Extras_ExtrasId",
                        column: x => x.ExtrasId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementsExtras_ExtrasId",
                table: "AdvertisementsExtras",
                column: "ExtrasId");
